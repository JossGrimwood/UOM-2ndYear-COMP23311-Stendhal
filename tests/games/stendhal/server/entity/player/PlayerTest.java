...
public class PlayerTest {
	...
	/**
	 * Tests for PetMessageOnZoneChange.
	 */
	@Test
	public void testPetMessageOnZoneChange() {
		StendhalRPZone zone1 = new StendhalRPZone("test zone", 15, 15);
		...
		Sheep meh = new Sheep(player);
		zone1.add(meh);
		
		StendhalRPAction.placeat(zone1, player, 1, 1);
		StendhalRPAction.placeat(zone1, meh, 14, 14);
		
		player.handleSimpleCollision(-1, -1);
		player.sendPrivateText("false");
		assertTrue(player.events().get(0).get("text").startsWith("You were told to watch your pet, weren't you?"));
	}
